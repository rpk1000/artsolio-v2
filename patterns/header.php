...
<figure class="wp-block-image size-large is-resized art-header-logo"><a href="https://artsolioslidedev01.local/"><img src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/images/artsolio-logo.svg" alt="<?php esc_attr_e('Artsolio logo - return home.', 'artsolio2');?>" style="width:161px;height:auto" title=""/></a></figure>
<!-- /wp:image -->
